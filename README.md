...
| `schema/` | The deployment-definition schema and its explainer (Step 1). |
| `fixtures/dallas/` | The Dallas golden fixture: `bottling-company-test/` expressed in the definition language, with a traceability proof (Step 1). |
